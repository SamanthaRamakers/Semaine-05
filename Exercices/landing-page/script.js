...
fetch("https://quotes-light-api.herokuapp.com/api/comments/", {
  ...
  //ensute je stock ma réponse pour la mettre dans le tableau
  .then(response => {
    let data = response;
    data.forEach(element => {
      ...
      // je greffe le ocntenu
      let currentDiv = document.
        getElementById("point-de-repere");
      document.body.insertBefore(divAuteur, currentDiv.nextSibling);
      document.body.insertBefore(divComment, currentDiv.nextSibling);
      ...
      //je spécifie à quel endroit de mon HTLM je veux insérer ce contenu
